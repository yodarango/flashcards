export const PhysicalSensations = [
  ...
  { spanish: "culpable", english: "guilty " },
  { spanish: "celoso", english: "jealous " },
  { spanish: "esperanzado", english: "hopeful " },
  ...
  { spanish: "solo", english: "lonely " },
  { spanish: "amado", english: "loved " },
  { spanish: "rechazado", english: "rejected " },
